...
module.exports = {
    addBoolParam,
    addCommonGenericParams,
    addIntParam,
    addProjectOption,
    addServerIdOption,
    addStringParam,
    addTrailingSlashIfNeeded,
    appendBuildFlagsToCliCommand,
    assembleUniqueServerId,
    buildCliArtifactoryDownloadUrl,
    cliJoin,
    compareVersions,
    configureArtifactoryCliServer,
    configureArtifactoryCliServerAsync,
    configureDefaultArtifactoryServer,
    configureDefaultArtifactoryServerAsync,
    configureDefaultDistributionServer,
    configureDefaultDistributionServerAsync,
    configureDefaultJfrogServer,
    configureDefaultJfrogServerAsync,
    configureDefaultXrayServer,
    configureDefaultXrayServerAsync,
    configureJfrogCliServer,
    configureJfrogCliServerAsync,
    createAuthHandlers,
    createBuildToolConfigFile,
    createBuildToolConfigFileAsync,
    defaultJfrogCliVersion,
    determineCliWorkDir,
    downloadCli,
    encodePath,
    executeCliCommand,
    executeCliCommandAsync,
    executeCliTask,
    executeCliTaskAsync,
    extractorsRemoteEnv,
    fixWindowsPaths,
    ...
    getJfrogFolderPath,
    handleSpecFile,
    isServerIdEnvSupported,
    isToolExists,
    isWindows,
    jfrogCliToolName,
    minCustomCliVersion,
    pipelineRequestedCliVersionEnv,
    quote,
    removeExtractorsDownloadVariables,
    removeExtractorsDownloadVariablesAsync,
    setJdkHomeForJavaTasks,
    singleQuote,
    stripTrailingSlash,
    taskDefaultCleanup,
    taskDefaultCleanupAsync,
    taskSelectedCliVersionEnv,
    useCliServer,
    useCliServerAsync,
    writeSpecContentToSpecPath,   
};
